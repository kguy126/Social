                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-8 m-auto">
                           ...
                           <p className="lead text-center text-white"> Add any form of educatuon that you have had in the past or current</p>
...
AddEducation.propTypes = {
  ...
  export default connect(mapStateToProps,{addEducation} )(withNavigateHook(AddEducation));
